...
const Footer = () => {
    return (
        <div className='max-w-300 mx-auto text-white px-4 lg:px-0'>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 pt-30 pb-20'>
                <div className='col-span-2 space-y-4'>
                    ...
                    <p className='text-sm md:text-base font-normal text-white/60 md:w-[80%]'>Premium digital tools for creators, professionals, and businesses. Work smarter with our suite of powerful tools.</p>
                </div>
